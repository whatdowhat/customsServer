...
public class CommonMasterSpecification {

	final static String startTouch = " 00:00:00";
	final static String endTouch = " 23:59:59";
	public static Specification<CommonMaster> withCondition(Map<String, String> condition) {

		return (Specification<CommonMaster>) ((root, query, builder) -> {
			List<Predicate> predicate = getPredicateWithKeyword(condition, root, builder);
			return builder.and(predicate.toArray(new Predicate[0]));
		});
	}

	private static List<Predicate> getPredicateWithKeyword(Map<String, String> conditino, Root<CommonMaster> root,
