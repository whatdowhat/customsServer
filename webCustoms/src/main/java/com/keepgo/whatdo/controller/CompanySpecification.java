...
public class CompanySpecification {
	...
	public static Specification<CompanyInfo> withCondition(Map<String, String> condition) {

		return (Specification<CompanyInfo>) ((root, query, builder) -> {
			List<Predicate> predicate = getPredicateWithKeyword(condition, root, builder);
			return builder.and(predicate.toArray(new Predicate[0]));
		});
	}

	private static List<Predicate> getPredicateWithKeyword(Map<String, String> conditino, Root<CompanyInfo> root,
